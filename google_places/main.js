      ...
      L.geoJson(response, {
          onEachFeature: function (feature, layer) {
              layer.on("click",function(){
                ...
                document.getElementById("place_address").innerHTML = feature.properties.formatted_address;
                document.getElementById("place_phone_number").innerHTML = feature.properties.formatted_phone_number;
                document.getElementById("place_website").innerHTML = feature.properties.website;
              });
          }
